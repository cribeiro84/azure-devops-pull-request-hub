                          ...
                          return (
                            policy.isReviewersApprovedOk !== undefined ?
                              policy.isReviewersApprovedOk ?
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleCheckmark icon-green"></span></td><td className="span-tooltip">{policy.reviewerCount} of {policy.minimumApproverCount} reviewers approved</td></tr>
                              :
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleErrorX icon-red"></span></td><td className="span-tooltip">{policy.reviewerCount} of {policy.minimumApproverCount} reviewers approved</td></tr>
                            :
                            policy.isRequiredReviewerOk !== undefined ?
                              policy.isRequiredReviewerOk ?
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleCheckmark icon-green"></span></td><td className="span-tooltip">Required reviewers approved{
                              ...
                              :
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleErrorX icon-red"></span></td><td className="span-tooltip">Required reviewers have not approved{
                                  (policy.requiredReviewers !== undefined && policy.requiredReviewers.length > 0 && policy.requiredReviewers[0].displayName !== "") ? 
                                    " - " + policy.requiredReviewers[0].displayName 
                                  : 
                                  null}
                            ...
                            policy.isWorkItemOk !== undefined ?
                             policy.isWorkItemOk ?
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleCheckmark icon-green"></span></td><td className="span-tooltip">Work items linked</td></tr>
                              :
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleErrorX icon-red"></span></td><td className="span-tooltip">No work items linked</td></tr>
                            :
                            policy.isCommentOk !== undefined ?
                              policy.isCommentOk ?
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleCheckmark icon-green"></span></td><td className="span-tooltip">All comments resolved</td></tr>
                              :
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleErrorX icon-red"></span></td><td className="span-tooltip">Not all comments resolved</td></tr>
                            :
                            policy.isBuildOk !== undefined ?
                              policy.isBuildOk ?
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleCheckmark icon-green"></span></td><td className="span-tooltip">Build success</td></tr>
                              :
                                <tr><td className="td-vertical-align"><span className="fabric-icon ms-Icon--StatusCircleErrorX icon-red"></span></td><td className="span-tooltip">Build problem</td></tr>
                            : null
                          );
                        })
                      :
